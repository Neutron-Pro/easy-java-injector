...
import fr.neutronstars.easy.java.injector.api.exception.InjectorScannerException;
...
class ScannerResolver {
    ...
    protected Scope scope(Class<?> clazz) {
        for (final Annotation annotation : clazz.getAnnotations()) {
            ...
            if (annotationClazz.isAnnotationPresent(fr.neutronstars.easy.java.injector.api.annotation.Scope.class)) {
